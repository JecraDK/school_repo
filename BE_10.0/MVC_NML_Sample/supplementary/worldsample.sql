...
insert into user (uid, password) values('anybody', '$2y$10$9tkG3R7unLcTQn2MAjLYROp9WwsAnMfjzlq.brGVppPhuKf5u240i');
insert into user (uid, password, activated) values('somebody', '$2y$10$6S035zYRuq2wDcQXpdlBcOpQO1snuok9DvLUL8co5uegU6vl52xy2', true);
insert into user (uid, password, activated, profile) values('admin', '$2y$10$6S035zYRuq2wDcQXpdlBcOpQO1snuok9DvLUL8co5uegU6vl52xy2', true, 'admin');
